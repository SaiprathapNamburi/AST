...
public class AppStartTimeExtractor {
    ...
    public static String getAppStartTime() throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (standardMatcher.find()) {
                ...
                motoDisplayedTime = motoMatcher.group(1);  // Capture Moto time but prioritize Displayed logs
            }
        }

        return (displayedTime != null) ? displayedTime : (motoDisplayedTime != null ? motoDisplayedTime : "N/A");
    }
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String buildType = "Playstore";  // Change to "Release" for release build
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            // Print the app start time (only this output)
